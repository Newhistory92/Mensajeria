...
var increaseBackOffTime = function increaseBackOffTime(currentBackoffTime) {
  return Math.min(currentBackoffTime * 2, 30000);
}; // Máximo de 30 segundos
var calculateBackOffDelayMs = function calculateBackOffDelayMs(backoffTime) {
  return Math.floor(1000 * (backoffTime + Math.random()));
}; // Variación aleatoria
 ...
 */
var backOff = function backOff(minTime, maxTime, fn, onSuccess, onError, onErrorEnd) {
  var currentBackoffTime = minTime;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            if (onErrorEnd) onErrorEnd.apply(void 0, [_context.t0].concat(args));
            return _context.abrupt("return");
          case 13:
            if (onError) onError(_context.t0);
            delay = calculateBackOffDelayMs(currentBackoffTime);
            console.log("[BACKOFF] Reintento en ".concat(delay, "ms"));
            setTimeout(function () {
              currentBackoffTime = increaseBackOffTime(currentBackoffTime);
              _attempt.apply(void 0, args);
            }, delay);
          case 17:
          case "end":
