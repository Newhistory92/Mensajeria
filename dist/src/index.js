...
var _require = require('./productor'),
  startProducer = _require.startProducer;
var _require2 = require('./consumidor'),
  startConsumer = _require2.startConsumer;
...
function _startService() {
  _startService = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var app;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          app.listen(PORT, function () {
            console.log("[SERVER] Servidor iniciado en puerto ".concat(PORT));
          });
        ...
        case 11:
          ...
          console.error('[SERVICE] Error al iniciar el servicio:', _context.t0);
          process.exit(1);
        case 15:
        case "end":
