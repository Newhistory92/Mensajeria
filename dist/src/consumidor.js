...
var _require = require("./config/bd"),
  rabbitSettings = _require.rabbitSettings,
  exchangeName = _require.exchangeName;
var _require2 = require("./controller/getNotificaciones.js"),
  updateNotificationStatus = _require2.updateNotificationStatus;
var _require3 = require("./services/emailService"),
...
function consumeQueue(_x, _x2) {
  return _consumeQueue.apply(this, arguments);
} // Función para consumir colas
function _consumeQueue() {
  _consumeQueue = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(queueName, routingKey) {
    var conn, canal;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          conn = _context2.sent;
          console.log("[CONSUMER] Conectado a RabbitMQ para la cola: ".concat(queueName));
          _context2.next = 7;
          return conn.createChannel();
        case 7:
          canal = _context2.sent;
          console.log("[CONSUMER] Canal creado para la cola: ".concat(queueName));
        ...
        case 13:
          _context2.next = 15;
          return canal.bindQueue(queueName, exchangeName, routingKey);
        case 15:
          console.log("[CONSUMER] Esperando mensajes en la cola: ".concat(queueName));

          // Consumir mensajes
          canal.consume(queueName, /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    console.log("[CONSUMER] Mensaje recibido en ".concat(queueName, ":"), content);

                    // Actualizar estado a Recibido
                    _context.next = 6;
                    return updateNotificationStatus(content.id, 'Recibido');
                  case 6:
        ...
        case 19:
          ...
          console.error("[CONSUMER] Error al consumir mensajes de la cola ".concat(queueName, ":"), _context2.t0);
        case 22:
        case "end":
...
function startConsuming() {
  return _startConsuming.apply(this, arguments);
}
function _startConsuming() {
  _startConsuming = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
